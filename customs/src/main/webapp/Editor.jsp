...
<%@ page language="java"
	import="java.util.*,java.sql.*,com.scutpress.customs.filter.*,com.scutpress.customs.tools.*"
	pageEncoding="UTF-8"%>
<%
...
<body>
	...
	<form method="post" action="" name="form"
		...
		<%
			...
			List<DocBean> editorList = editdao.getEditorInfo();
			...
			//	e.printStackTrace();
			//}
			int resultconts = editorList.size();
			int totalPages = m_pages.getTotal_Pages(resultconts);//取出总页数
			Iterator<DocBean> it = editorList.iterator();
	...
	<form method="post" name="form2">
		<div class="search1">
			<div align="right">
				<span> 关键字：<input name="keyword" type="text" maxlength="20"
					style="width: 200px;"> 文档起草人<input name="builder"
					type="text" maxlength="20" style="width: 200px;"><br /> <label>档案类别：
				...
				</label> 起草日期： <input type="text" name="startBt" style="width: 100px"
					onFocus="HS_setDate(this)"> 至 <input type="text"
					name="endBt" style="width: 100px" onFocus="HS_setDate(this)">

				</span> <span> <input name="search" type="button" value="搜索"
					onClick="form2.action='SearchServlet?jsp=Editor';form2.submit();" />
				</span>
	...
	<form action="ProChStaServlet" method="post" name="form3">
		<br> <br> <br> <br>
		<div class="M_table">
			<table width="960" border="1" align="center" cellpadding="1"
				...
				<tr bgcolor="#EBF4FB">
					...
					%>
					<td><%=bean.getTitle()%></td>
					<td height="33"><%=bean.getBuildTime()%></td>
					<td><%=dao.getDocClass(bean.getClassId()).get(0)%></td>
					<td><%=bean.getBuilder()%></td>
