...
<body>
	...
	<div id="Layer1">
		<fieldset>
			<legend></legend>
			<p align="center">
				<strong><%=bli.get(0).getTitle()%></strong>
			</p>
			<br>
			<p><%=bli.get(0).getFullText()%>&nbsp;
			</p>
			<br>
			<p><%=bli.get(0).getTranslateText()%>&nbsp;
			</p>
		</fieldset>
	</div>
		...
		<div>
			...
			<div class="biaoge" style="width: 410px; height: 470px;">
				...
				<table width="100%" border="1" cellpadding="1" cellspacing="0">
					<tr>
						<td colspan="2"><span class="STYLE7">标题： <input
								type="text" name="retitle" value="<%=bli.get(0).getTitle()%>"
								style="width: 303px;">
						</span></td>
					</tr>
					<tr>
						<td><span class="STYLE7">关键词： <input type="text"
								name="keywords" value="<%=bli.get(0).getKeyWords()%>"
								style="width: 94px;"></span></td>
						<td><span class="STYLE7">关键人： <input type="text"
								name="keypersons" value="<%=bli.get(0).getKeyPersons()%>"
								style="width: 94px;">
						</span></td>
					</tr>
					<tr>
						<%-- <td><span class="STYLE7">起草日期：<input type="text" name ="btime" value ="<%=bli.get(0).getBuildTime()%>" style="width: 80px; "></span></td> --%>
						<td><span class="STYLE7">起草日期：<input type="text"
								style="width: 70px" onfocus="HS_setDate(this)" name="btime"
								value="<%=bli.get(0).getBuildTime()%>"></span></td>
						<td><span class="STYLE7">起草人：<input type="text"
								name="builder" value="<%=bli.get(0).getBuilder()%>"
								style="width: 101px;"></span></td>
					</tr>
					<tr>
						<td colspan="2"><span class="STYLE7">摘要：<textarea
									name="abstract" cols="50" rows="1"
									style="width: 345px; height: 22px"><%=bli.get(0).getDocAbstract()%>" </textarea></span></td>
					</tr>
					<tr>
						<td colspan="2" style="height: 200px;">
							<div class="STYLE7"
								style="height: 200px; overflow-y: scroll; border: 0 solid;">
								原文：<br>
					...
					<tr>
						<td><div align="center">
								<span class="STYLE12" align="center"
									onMouseOver="MM_showHideLayers('Layer1','','show')"
									onMouseOut="MM_showHideLayers('Layer1','','hide')"> <img
									src="images/view.png" width="20" height="20" /><span
									class="STYLE11">预览档案</span></span>
							</div></td>
						<td style="height: 25px;"><span class="STYLE9"> <a
								href="ProFile.jsp">返回</a> &nbsp; <a
								href="ProResult.jsp?id=<%=request.getParameter("id")%>">提交档案</a></span>&nbsp;

							<input onClick="form.action='ProUpdateServlet';form.submit();"
