...
<body>
	...
	<form method="post" action="" name="form" style="height: 0;">
		<p>
			...
			<%
				...
				List<NewsBean> newList = pubdao.getPublisherInfo(uid);
	...
	<form method="post" name="form2">
		<div class="search1">
			...
			<div align="center">
				<span>栏目： <select name="selectNewCol">
						<%
					...
					onClick="form2.action='SearchServlet?jsp=Publisher';form2.submit();" />
				</span> <span class="STYLE4 STYLE22"> </span>
			</div>
		...
		<div class="M_table">
			<table width="960" border="1" align="center" cellpadding="1"
				...
				<tr>
					...
					<%
						while (itet.hasNext()) {
							NewsBean bean = itet.next();
					%>

					<td><%=bean.getTitle()%></td>
					<td><%=pubdao.getNewCol(bean.getColumnId()).get(0)%></td>
					<td><%=bean.getInputDate()%></td>
					<td><a href="NewEdit.jsp?id=<%=bean.getID()%>"> <img
							src="images/change.png" alt="编辑" width="25" height="25"
							hspace="14">
					</a></td>
					<td width="56"><a
						href="DelServlet?id=<%=bean.getID()%>&jsp=Publisher"> <img
							src="images/dele.png" width="23" height="23" hspace="18">
					</a></td>
				</tr>
				<%
					i = i + 1;
			...
			<div align="right">
				<br> <a href="Pubnew.jsp" class="STYLE29">查看已通过审核的新档案列表</a>
