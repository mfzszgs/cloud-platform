...
<body>
	...
	<%
		...
		List<DocBean> infoList = uploaderdao.getUploaderInfo();
	...
	<form method="post" enctype="multipart/form-data"
		action="UploadServlet" name="form" style="height: 5px;">
		<table width="83%" border="0" align="right" cellpadding="0"
			...
			<tr>
				...
				<td width="197" style="width: 145px;">选择档案类别： <label> <select
						name="selectDocClass">
							<%
				...
				<td width="64" style="width: 79px;"><label> <input
		...
		<p>
			...
			<a
				href="LogoutServlet?loginName=<%=session.getAttribute("loginName")%>">注销
			</a>
		</p>
		...
		<div class="search">
			<div align="center">
				<span> <img src="images/search1.png" height="43"
					style="width: 553px;"> <input name="keyword" type="text"
				...
				</span> <span class="STYLE4 STYLE22"> 共有<%=docli.size()%>条记录
				</span>
			</div>
		</div>
	</form>
			...
			<table width="960" border="1" align="center" cellpadding="1"
				...
				<tr>
					...
					<td width="49"><div align="center">
							<img src="images/edit.png" width="48" height="24">
						</div></td>
