		...
		<p>
			...
			<a
				...
				class="STYLE21"> <u>注销</u>
					...
					<span class="STYLE25">&nbsp; <a href="ProFile.jsp"
						class="STYLE25"><em><strong> <img
									src="images/book.png" alt="" style="height: 25px; width: 25px;" /></strong></em><strong
							style="color: #00F">已接包列表</strong></a></span>
			</label>
			</span>
		</p>
	</form>
	...
	<form method="post" name="form2">
		<div class="search1">
			...
			<div align="center">
				...
				</label> <input name="keyword" type="text" maxlength="20"
					style="width: 196px;">
		...
		<div class="M_table">
			<table width="960" border="1" align="center" cellpadding="1"
				...
				<tr bgcolor="#EBF4FB">
					...
					<td style="width: 38px;"><input type="checkbox" name="choose"
						value="<%=bean.getID()%>"></td>
				</tr>
			...
			<p align="center">
				...
				%>
				<input type="button" name="confirm" value="申请接包"
					onClick="do_action();">
				<%
					}
				%>
			...
			<p align="center" class="STYLE28">
				<span class="STYLE29"><em>*注释*&nbsp;</em></span><em>&nbsp;&nbsp;&nbsp;</em>
				<em>此列表显示全部可接包档案。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;搜索
					：可分别按照档案类别或关键字进行检索。<a href="ProShow.jsp"></a>
				</em><a href="ProShow.jsp">详细流程图</a>
			</p>
