<%@page import="com.scutpress.customs.beans.*"%>
<%@page import="java.sql.ResultSet"%>
<%@ page language="java"
	import="java.util.*,java.sql.*,com.scutpress.customs.filter.*"
	pageEncoding="UTF-8"%>
<%
...
<body>
	...
	<p>
		<jsp:useBean id="m_pages" scope="page" class="com.scutpress.customs.beans.Pagination">
		</jsp:useBean>
	</p>
	<form method="post" action="" name="form" style="height: 0;">
		<p>
			...
			<%
				...
				List<DocBean> infoList = prodao.getProcesserInfo();
				...
				//	e.printStackTrace();
				//}
				int resultconts = infoList.size();
				int totalPages = m_pages.getTotal_Pages(resultconts);//取出总页数
				Iterator<DocBean> it = infoList.iterator();
				Iterator<DocBean> itet = m_pages.getPageSet(it, curPages);
			%>
			...
			</a><span class="STYLE24"> <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
					class="STYLE25">&nbsp;<a href="Processer.jsp"
						class="STYLE25"><em><strong><img
									src="images/bag.png" alt="" style="height: 25px; width: 25px;" /></strong></em><strong
							style="color: #00F">可接包列表</strong></a></span></label>
			</span>
	...
	<form method="post" name="form2">
		<div class="search1">
			...
			<div align="center">
				<span>档案状态： <select name="selectDocState">
						<%
				...
				</select> <input name="keyword" type="text" maxlength="20"
					style="width: 196px;">
				</span> <span> <input name="search" type="button" value="搜索"
					onClick="form2.action='SearchServlet?jsp=ProFile';form2.submit();" />
				</span> <span class="STYLE4 STYLE22"> <%-- <%
			...
			<table width="960" border="1" align="center" cellpadding="1"
				...
				<tr>
					...
					<td width="139"><div align="center">
							<img src="images/status.png" width="80" height="24">
						</div></td>
					<td width="55"><div align="center">
							<img src="images/edit.png" width="48" height="24" hspace="10">
						</div></td>
					<td width="56"><img src="images/cancle.png" width="48"
						height="24" hspace="9"></td>
				</tr>
				<tr>
					<%
						int i = 1;
					...
					<%
						while (itet.hasNext()) {
							DocBean bean = itet.next();
					%>
					<td><%=bean.getTitle()%></td>
					<td><%=dao.getDocClass(bean.getClassId()).get(0)%></td>
					<td><%=prodao.getDocState(bean.getState()).get(0)%></td>
					<td>
						<%
							if (bean.getState() != 5) {
						%> <a href="ProMain.jsp?id=<%=bean.getID()%>"> <img
							src="images/change.png" alt="编辑" width="25" height="25"
							hspace="14">
					</a> <%
 	} else {
 %> <!-- 未通过的的文档，查看修改建议 --> <a
						href="ProSuggestion.jsp?id=<%=bean.getID()%>"> <!-- <img src="images/change.png" alt="编辑" width="25" height="25" hspace="14"> -->
							查看意见
					</a> <%
 	}
 %>
					...
					<td width="56"><a
						href="DelServlet?id=<%=bean.getID()%>&jsp=ProFile"
						onClick="del();"> <img src="images/dele.png" width="23"
							height="23" hspace="18">
					</a></td>
				</tr>
				<%
			...
			<span>共有<%=resultconts%>条数据,共<%=totalPages%>页
			</span>
			<p align="center">
			...
			<p align="center" class="STYLE28">
				<span class="STYLE29"><em>*注释*</em>&nbsp;&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em>列表显示全部可包档案。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;搜索：可分别按照档案类别或关键字进行检索。<a
					href="ProShow.jsp"></a></em><a href="ProShow.jsp">详细流程图</a>
			</p>
